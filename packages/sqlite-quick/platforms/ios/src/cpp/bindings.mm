...
void QuickSQLiteJSIModule::install(jsi::Runtime &rt, const char *docPath) {
  ...
  auto open = jsi::Function::createFromHostFunction(
      rt, jsi::PropNameID::forAscii(rt, "open"), 2,
      [](jsi::Runtime &runtime, const jsi::Value &thisValue,
        ...
        if (!args[0].isString()) {
          throw jsi::JSError(runtime,
                              "[react-native-quick-sqlite][open] database "
        ...
        if (count > 1 && !args[1].isUndefined() && !args[1].isNull()) {
          ...
          tempDocPath =
              tempDocPath + "/" + args[1].asString(runtime).utf8(runtime);
        }
  ...
  //   quick_module, 2, ([](jsi::Runtime &rt, const jsi::Value &thisValue,
  //                   const jsi::Value *args, size_t count) -> jsi::Value
  //                   {
