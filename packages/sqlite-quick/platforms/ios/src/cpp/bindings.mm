...
void install(jsi::Runtime &rt, const char *docPath) {
  ...
  // invoker = jsCallInvoker;
    ...
    auto open = jsi::Function::createFromHostFunction(rt, jsi::PropNameID::forAscii(rt, "open"), 2, [](jsi::Runtime &runtime, const jsi::Value &thisValue,
         const jsi::Value *args, size_t count) -> jsi::Value {
        if (count == 0) {
          throw jsi::JSINativeException(
              "[react-native-quick-sqlite][open] database name is required");
        }

        if (!args[0].isString()) {
          throw jsi::JSINativeException("[react-native-quick-sqlite][open] database "
        ...
        if (count > 1 && !args[1].isUndefined() && !args[1].isNull()) {
          ...
          tempDocPath = tempDocPath + "/" + args[1].asString(runtime).utf8(runtime);
        }

        SQLiteOPResult result = sqliteOpenDb(dbName, tempDocPath);

        if (result.type == SQLiteError) {
          throw jsi::JSINativeException(result.errorMessage.c_str());
        }

        return jsi::Value::undefined();
      });

  // auto attach = CREATE_FUNC("attach", quick_module, 4, ([](jsi::Runtime
  // &runtime, const jsi::Value &thisValue,
  //                   const jsi::Value *arguments, size_t count) -> jsi::Value
  //                   {
  //   if (count < 3) {
  //     throw jsi::JSError(
  //         rt,
  //         "[react-native-quick-sqlite][attach] Incorrect number of
  //         arguments");
  //   }
  ...
  // auto detach = CREATE_FUNC("detach", quick_module, 2, ([](jsi::Runtime
  // &runtime, const jsi::Value &thisValue,
  //                   const jsi::Value *arguments, size_t count) -> jsi::Value
  //                   {
  //   if (count < 2) {
  //     throw jsi::JSError(
  //         rt,
  //         "[react-native-quick-sqlite][detach] Incorrect number of
  //         arguments");
  //   }
  ...
  // auto close = CREATE_FUNC("close", quick_module, 1, ([](jsi::Runtime
  // &runtime, const jsi::Value &thisValue,
  //                   const jsi::Value *arguments, size_t count) -> jsi::Value
  // {
  //   if (count == 0) {
  //     throw jsi::JSError(
  //         rt, "[react-native-quick-sqlite][close] database name is
  //         required");
  //   }
  ...
  //     throw jsi::JSError(
  //         rt,
  //         "[react-native-quick-sqlite][close] database name must be a
  //         string");
  //   }
  ...
  // auto remove = CREATE_FUNC("delete", quick_module, 2, ([](jsi::Runtime
  // &runtime, const jsi::Value &thisValue,
  //                   const jsi::Value *arguments, size_t count) -> jsi::Value
  // {
  //   if (count == 0) {
  ...
  //     throw jsi::JSError(
  //         rt,
  //         "[react-native-quick-sqlite][open] database name must be a
  //         string");
  //   }
  ...
  // auto execute = CREATE_FUNC("execute", quick_module, 3, ([](jsi::Runtime
  // &runtime, const jsi::Value &thisValue,
  //                   const jsi::Value *arguments, size_t count) -> jsi::Value
  // {
  ...
  // auto executeAsync = CREATE_FUNC("executeAsync", quick_module, 3,
  ...
  //   auto promise = promiseCtr.callAsConstructor(rt, CREATE_FUNC("executor",
  //   quick_module, 2, ([](jsi::Runtime &runtime, const jsi::Value &thisValue,
  //                   const jsi::Value *arguments, size_t count) -> jsi::Value
  //                   {
  ...
  //         vector<QuickColumnMetadata> metadata;
  //         auto status =
  //             sqliteExecute(dbName, query, params.get(), &results,
  //             &metadata);
  //         invoker->invokeAsync(
  //             [&rt,
  //              results = make_shared<vector<map<string,
  //              QuickValue>>>(results), metadata =
  //              make_shared<vector<QuickColumnMetadata>>(metadata),
  ...
  // auto executeBatch = CREATE_FUNC("executeBatch", quick_module, 2,
  // ([](jsi::Runtime &runtime, const jsi::Value &thisValue,
  //                   const jsi::Value *arguments, size_t count) -> jsi::Value
  // {
  //   if (sizeof(args) < 2) {
  ...
  //     jsi::Value(batchResult.affectedRows)); return move(res);
  //   } else {
  //     throw jsi::JSError(rt, batchResult.message);
  //   }
  // });

  // auto executeBatchAsync = CREATE_FUNC("executeBatchAsync", quick_module, 2,
  // ([](jsi::Runtime &runtime, const jsi::Value &thisValue,
  //                   const jsi::Value *arguments, size_t count) -> jsi::Value
  // {
  //   if (sizeof(args) < 2) {
  ...
  // auto loadFile = CREATE_FUNC("loadFile", quick_module, 2, ([](jsi::Runtime
  // &runtime, const jsi::Value &thisValue,
  //                   const jsi::Value *arguments, size_t count) -> jsi::Value
  // {
  //   const string dbName = args[0].asString(rt).utf8(rt);
  ...
  // auto loadFileAsync = CREATE_FUNC("loadFileAsync", quick_module, 2,
  // ([](jsi::Runtime &runtime, const jsi::Value &thisValue,
  //                   const jsi::Value *arguments, size_t count) -> jsi::Value
  // {
  //   if (sizeof(args) < 2) {
