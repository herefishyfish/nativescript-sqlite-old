...
void install(jsi::Runtime &rt, const char *docPath) {
  ...
  auto open = CREATE_FUNC("open", quick_module, 2, ([](jsi::Runtime &runtime, const jsi::Value &thisValue,
  ...
  auto attach = CREATE_FUNC("attach", quick_module, 4, ([](jsi::Runtime &runtime, const jsi::Value &thisValue,
                    const jsi::Value *arguments, size_t count) -> jsi::Value {
    if (count < 3) {
      throw jsi::JSError(
          rt,
  ...
  auto detach = CREATE_FUNC("detach", quick_module, 2, ([](jsi::Runtime &runtime, const jsi::Value &thisValue,
                    const jsi::Value *arguments, size_t count) -> jsi::Value {
    if (count < 2) {
      throw jsi::JSError(
          rt,
  ...
  auto close = CREATE_FUNC("close", quick_module, 1, ([](jsi::Runtime &runtime, const jsi::Value &thisValue,
                    const jsi::Value *arguments, size_t count) -> jsi::Value
  {
    if (count == 0) {
      throw jsi::JSError(
  ...
  auto remove = CREATE_FUNC("delete", quick_module, 2, ([](jsi::Runtime &runtime, const jsi::Value &thisValue,
                    const jsi::Value *arguments, size_t count) -> jsi::Value
  {
    if (count == 0) {
      throw jsi::JSError(
  ...
  auto execute = CREATE_FUNC("execute", quick_module, 3, ([](jsi::Runtime &runtime, const jsi::Value &thisValue,
                    const jsi::Value *arguments, size_t count) -> jsi::Value
  {
  ...
  // auto executeAsync = CREATE_FUNC("executeAsync", quick_module, 3, ([](jsi::Runtime &runtime, const jsi::Value &thisValue,
  //                   const jsi::Value *arguments, size_t count) -> jsi::Value
  // {
  //   if (count < 3) {
  ...
  //   auto promise = promiseCtr.callAsConstructor(rt, CREATE_FUNC("executor", quick_module, 2, ([](jsi::Runtime &runtime, const jsi::Value &thisValue,
  //                   const jsi::Value *arguments, size_t count) -> jsi::Value {
  ...
  auto executeBatch = CREATE_FUNC("executeBatch", quick_module, 2, ([](jsi::Runtime &runtime, const jsi::Value &thisValue,
                    const jsi::Value *arguments, size_t count) -> jsi::Value
  {
    if (sizeof(args) < 2) {
  ...
  // auto executeBatchAsync = CREATE_FUNC("executeBatchAsync", quick_module, 2, ([](jsi::Runtime &runtime, const jsi::Value &thisValue,
  //                   const jsi::Value *arguments, size_t count) -> jsi::Value
  // {
  //   if (sizeof(args) < 2) {
  ...
  auto loadFile = CREATE_FUNC("loadFile", quick_module, 2, ([](jsi::Runtime &runtime, const jsi::Value &thisValue,
                    const jsi::Value *arguments, size_t count) -> jsi::Value
  {
    const string dbName = args[0].asString(rt).utf8(rt);
  ...
  // auto loadFileAsync = CREATE_FUNC("loadFileAsync", quick_module, 2, ([](jsi::Runtime &runtime, const jsi::Value &thisValue,
  //                   const jsi::Value *arguments, size_t count) -> jsi::Value
  // {
  //   if (sizeof(args) < 2) {
